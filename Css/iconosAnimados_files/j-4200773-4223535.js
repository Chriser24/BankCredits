//Generated:2023-02-15 21:31:45// 6-273
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4200773 || '',
    guid: window.ftGUID_4200773 || '',
    confID: window.ftConfID_4200773 || '0',
    ftReturn: window.ftReturn_4200773 || '',
    keyword: window.ftKeyword_4200773 || '',
    ftId: window.ftId_4200773 || '',
    ftImpId: window.ftImp4200773 && window.ftImp4200773.impID || '',
    gdpr: window.ftImp4200773 && window.ftImp4200773.gdpr || '',
    gdpr_consent: window.ftImp4200773 && window.ftImp4200773.gdpr_consent || '',
    gdpr_pd: window.ftImp4200773 && window.ftImp4200773.gdpr_pd || '',
    us_privacy: window.ftImp4200773 && window.ftImp4200773.us_privacy || '',
    campaignID: '115847',
    cID: '155971',
    pID: '4200773',
    creativeID: '4223535',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115847&sid=18330&plc=4200773&num=&adid=&advid=&adsrv=29&btreg=4200773&btadsrv=flashtalking&crt=4223535&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115847;4200773;4223535;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/co/creativecloud/plans.html?sdid=GZKZY1B7&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?225360980-4200773;4223535;',
    centreAd: false,
    width: 300,
    height: 250,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/420/4200773/4223535/image/4223535.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115847;4200773;202;pixel;DV360;DV360FY20CCLALCCPaidCODSKBAN300x250/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115847;4200773;4223535;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/co/creativecloud/plans.html?sdid=GZKZY1B7&mv=display",
    divID: 'ftdiv4200773',
    altimgID: 'ftalt4200773',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4200773 && parseInt(window.ftImp4200773.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4200773') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4200773'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4200773").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4200773").style.display = "none";
		    }
		});
	}
}(ft4200773));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115847&l2=DV360&l3=4200773&l4=4223535&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115847&l2=DV360&l3=4200773&l4=4223535&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4200773;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4200773;
